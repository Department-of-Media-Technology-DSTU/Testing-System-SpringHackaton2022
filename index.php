            ...
            <form action="index.php?id=<?php echo $testId; ?>" method="post">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        ...
                        <div class="card mt-3">
                            <div class="card-header" style="background: #F8C202;">
                        ...
                        <div class="text-center mt-3">
                            <?php if ($questionCount == $questionNum && $questionNum!=0) { ?>
                                <button type="submit" class="btn btn-success" style="background: #FF666F;border-radius: 50px;">Получить результат</button>
                            <?php } else if ($questionNum!=0){ ?>
                                <button type="submit" class="btn" style="background: #F8C202;border-radius: 50px;">Дальше</button>
                            <?php } else if($questionNum==0){ ?>
                                <button onClick="addMail()" type="submit" class="btn" style="background: #F8C202;border-radius: 50px;">Начать тест</button>
                           <?php  }?>

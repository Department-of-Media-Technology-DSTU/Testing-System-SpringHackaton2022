    ...
    if($_POST['email']!='' && $_POST['password']!='')
    {
        ...
        if(!empty($res))
        {
            ...
            if($password==$db_password)
            {
                ...
                $append_this="<div class='text-center' style='color:red;'>
            ...
            $append_this="<div class='text-center' style='color:red;'>
            <h3> Такой пользовательно не зарегистрирован!</h3>
            </div>";
        }
...
<div class="row justify-content-center">
    <div class="col-md-6">
        ...
        <div class="text-center" class="card-header">
            ...
            <button class="copy-button" type="submit">Вход</button>
            </div>
            </div>
        </div>
        </div>
